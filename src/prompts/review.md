...
**If you could not get it, say you could not get it**: a tool that failed, a file that does not exist, a run whose worktree holds nothing at all — write that into the finding honestly, or leave the finding out. **Never invent file content, and never assume what a function does.**
